	...
	<div class="container">
		...
		<div class="main">
			<div class="search-container">
			  <form action="/QLProject/searchXV" method="GET">
			...
			<table>
			    ...
			    <c:forEach var="xe" items="${xeV}">
						<tr>
							...
							<td>${xe.loai}</td>
							<td>${xe.ngayVao}</td>
							<td><button><a href="/QLProject/xoaxeV?id=${xe.idXe}&id2=${xe.idThe}">Xóa</a></button></td>
						</tr>
				</c:forEach>
			</table>
			<div class="add">
				<button>
					<a href="/QLProject/themXeVao">Thêm Xe Vào</a>
				</button>
			</div>
		</div>
	</div>
